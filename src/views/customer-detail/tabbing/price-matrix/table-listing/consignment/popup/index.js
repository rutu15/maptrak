        ...
        >
          ...
          <DialogContent>
            <label className="label-text">
              {props.formik.values?.jobTypes?.name ? props.formik.values?.jobTypes?.name : ""} -{" "}
              {props.formik.values?.truckTypes?.name ? props.formik.values?.truckTypes?.name : ""}{" Hourly Charge "}
                  ...
                  <div className="textfield-wrapper">
                    ...
                    <FormControl variant="outlined">
                      <Select
                        ...
                        onChange={props.formik.handleChange}
                        value={props.formik.values.weekDaysChargeType ? props.formik.values.weekDaysChargeType : "HOUR"}
                      >
                  ...
                  <div className="textfield-wrapper">
                    ...
                    <FormControl variant="outlined">
                      <Select
                        ...
                        IconComponent={() => <ExpandMore />}
                        onChange={props.formik.handleChange}
                        value={props.formik.values.saturdayChargeType ? props.formik.values.saturdayChargeType : "HOUR"}
                      >
                        <MenuItem value={""} disabled>
                          Select Charge Type
                        </MenuItem>
                  ...
                  <div className="textfield-wrapper">
                    ...
                    <FormControl variant="outlined">
                      <Select
                        ...
                        IconComponent={() => <ExpandMore />}
                        onChange={props.formik.handleChange}
                        value={props.formik.values.sundayChargeType ? props.formik.values.sundayChargeType : "HOUR"}
                      >
                        <MenuItem value={""} disabled>
                          Select Charge Type
                        </MenuItem>
                  ...
                  <div className="textfield-wrapper">
                    ...
                    <FormControl variant="outlined">
                      <Select
                        ...
                        IconComponent={() => <ExpandMore />}
                        onChange={props.formik.handleChange}
                        value={props.formik.values.publicHoliday1ChargeType ? props.formik.values.publicHoliday1ChargeType : "HOUR"}
                      >
                        <MenuItem value={""} disabled>
                          Select Charge Type
                        </MenuItem>
                  ...
                  <div className="textfield-wrapper">
                    ...
                    <FormControl variant="outlined">
                      <Select
                        ...
                        IconComponent={() => <ExpandMore />}
                        onChange={props.formik.handleChange}
                        value={props.formik.values.publicHoliday2ChargeType ? props.formik.values.publicHoliday2ChargeType : "HOUR"}
                      >
                        <MenuItem value={""} disabled>
                          Select Charge Type
                        </MenuItem>
