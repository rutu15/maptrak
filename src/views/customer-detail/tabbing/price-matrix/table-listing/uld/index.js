...
function ULDListing(props) {
  ...
  const data = state?.customer?.priceMatrixData?.filter((item) => {
    return item?.cargoTypes?.name === "ULD";
  });
            ...
            <Table stickyHeader aria-label="simple table">
              <TableHead>
                <TableRow>
                  ...
                  <TableCell className="subCargoType">Sub Cargo Type</TableCell>
              ...
              <TableBody>
                {data?.map((row, index) => (
                  <TableRow key={index}>
                    ...
                    <TableCell className="subCargoType">
                      {row.uldTypes ? row.uldTypes.name : "-"}
                    </TableCell>
